...
RocketChat.settings.addGroup 'Layout', ->
	...
	@section 'Content', ->
		...
		@add 'Layout_Home_Body', 'Welcome to JDM-Central-Chat <br> Go to APP SETTINGS -> Layout to customize this intro.', { type: 'string', multiline: true, public: true }
	...
	@section 'Login', ->
		...
		@add 'Layout_Login_Terms', 'By proceeding to create your account and use JDM-Central-Chat, you are agreeing to our <a href="/terms-of-service">Terms of Service</a> and <a href="/privacy-policy">Privacy Policy</a>. If you do not agree, you cannot use JDM-Central-Chat.', { type: 'string', multiline: true, public: true }
